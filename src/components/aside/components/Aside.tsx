...
const Aside = () => {
	...
	return (
		<div ref={ref} className="fixed">
			...
			>
				<aside className="w-[200px] max-w-[200px] h-[calc(100vh-152px)] md:h-[calc(100vh-86px)] rounded-tr-3xl bg-dark mr-6 mt-4 pt-4 shadow-slate-100 overflow-y-scroll aside-container">
