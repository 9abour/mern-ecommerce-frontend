...
const BasketItem = ({ product }: { product: IProduct }) => {
	...
	return (
		<li className="w-full h-[30px] py-1 px-2 hover:bg-gray-100 text-gray-500 flex justify-between [&:hover>span]:hidden [&:hover>button]:flex transition-all">
			...
			<IconButton
				...
				customStyles="hidden bg-transparent text-red-600 hover:bg-red-600 hover:text-white !w-[22px] !h-[22px] transition-all"
				onclick={() => {
